...
class RecipeRepository:
    ...
    def get_recipes_by_user(self, user_id: int) -> list[Dict[str, Any]]:
    ...
    def create_recipe(self, user_id: int) -> int:
    ...
    def update_recipe(self, recipe_id: int, updated_data: Dict[str, Any]) -> bool:
        ...
        if not self.check_recipe_exists(recipe_id):
    ...
    def delete_recipe_by_id(self, recipe_id: int) -> bool:
